...
public class OneLaneWithMoreObstaclesScenario extends Scenario {

	public OneLaneWithMoreObstaclesScenario(Integer numberOfVoids) {
	...
	public Scene createScene() {
		...
		obstacles.add(new CircularVoid(new Void(new Vector(200,80), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(200,85), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(200,90), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(200,95), true), Color.BLACK));
		
		obstacles.add(new CircularVoid(new Void(new Vector(400,105), true), Color.BLACK));
		...
		obstacles.add(new CircularVoid(new Void(new Vector(600,80), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(600,85), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(600,90), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(600,95), true), Color.BLACK));

		obstacles.add(new CircularVoid(new Void(new Vector(800,105), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(800,110), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(800,115), true), Color.BLACK));
		obstacles.add(new CircularVoid(new Void(new Vector(800,120), true), Color.BLACK));
